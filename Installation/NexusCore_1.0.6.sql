...
SET AUTOCOMMIT=0;
USE `e2CMS`;
INSERT INTO `NexusUser_Users` (`UserID`, `UserName`, `Email`, `UserPass`, `CreateDate`, `CreateIPaddress`, `LastLoginDate`, `LastPasswordChangedDate`, `FailedPassAttemptCount`, `IsLockedOut`, `DeleteMark`, `Activation_Code`) VALUES (1, 'Administrator', 'default@domain.com', '1234567', '2011-03-21 00:00:00', '127.0.0.1', 0, 0, 0, 0, 0, '');
...
SET AUTOCOMMIT=0;
USE `e2CMS`;
INSERT INTO `NexusUser_UserInGroups` (`RelationID`, `UserID`, `UserGroupID`) VALUES (1, 1, NULL);
...
SET AUTOCOMMIT=0;
USE `e2CMS`;
INSERT INTO `NexusPhoto_Settings` (`SettingID`, `DisplayID`, `Image_BrokenURL`, `IsResize`, `Resize_Type`, `Resize_Height`, `Resize_Width`, `IsOverlay`, `Overlay_ImageURL`, `Overlay_Opacity`, `Overlay_Position`, `Overlay_PaddingX`, `Overlay_PaddingY`) VALUES (1, 'Default', '', 0, NULL, 0, 0, 0, '', 0, NULL, 0, 0);
