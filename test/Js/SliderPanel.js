	...
	************************************************************************************************************/		
	...
	function initSlideLeftPanel(expandOnly)
	{
		...
		if(!slideLeftPanelObj){
			if(document.getElementById('nexusCore_editor_toolPanel')){	// Object exists in HTML code?
				slideLeftPanelObj = document.getElementById('nexusCore_editor_toolPanel');
				...
				slideLeftPanelObj.id = 'nexusCore_editor_toolPanel';
