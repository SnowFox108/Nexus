...
SET AUTOCOMMIT=0;
USE `e2CMS`;
INSERT INTO `NexusCore_Modules` (`ModuleID`, `Module_Name`, `Module_Icon`, `Module_Type`, `Module_Version`, `Release_Date`, `Author`, `Description`) VALUES ('842C4297-FA78-4264-B6CD-7A6B5ECC0758', 'Login', '/App_Control_Style/Navigation/Icons/Nexus_Login', 'Customer Addon', '1.0.0', '2011-03-21', 'e2Tech.Ltd', 'Login');
