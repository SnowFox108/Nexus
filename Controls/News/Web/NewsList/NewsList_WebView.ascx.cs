...
namespace Nexus.Controls.News.NewsList
{
    public partial class WebView : System.Web.UI.UserControl
    {
        ...
        //protected bool IsEnable_NewsDate()
        //{
        //    return _enable_newsdate;
        //}

        protected void btn_NewsStatus_Show_Click(object sender, EventArgs e)
        {
            _news_status_show = droplist_NewsStatus_Show.SelectedValue;
            Control_Init();
        ...
        //protected string Get_NewsDetailURL(string NewsID)
        //{
        //    return Nexus.Core.Tools.URLParse.Combine_Arg(_newsdetailurl, string.Format("NexusNewsPostID={0}", NewsID));
