<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Login_WebView.ascx.cs" Inherits="Nexus.Controls.Login.Login.WebView" ClassName="Nexus.Controls.Login.Login.Login_WebView" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidator_Password" runat="server" 
                        ...
                        onservervalidate="CustomValidator_Password_ServerValidate" 
                        ValidationGroup="Nexus_Control_Login">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
