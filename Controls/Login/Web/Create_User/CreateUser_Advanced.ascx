<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CreateUser_Advanced.ascx.cs" Inherits="Nexus.Controls.Login.CreateUser.Advanced" ClassName="Nexus.Controls.Login.CreateUser.CreateUser_Advanced" %>

<asp:MultiView ID="MultiView_SignUp" runat="server">
    <asp:View ID="View_New" runat="server">
        <div align="center">
            Click "Edit" to modify sign up options.</div>
    </asp:View>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="tbx_UserName" Display="Dynamic" 
                    ...
                    <asp:CustomValidator ID="CustomValidator_UserName" runat="server" 
                        ControlToValidate="tbx_UserName" Display="Dynamic" 
                        ErrorMessage="The user name has been used by another account." 
                        OnServerValidate="CustomValidator_UserName_ServerValidate" 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidator_Email" runat="server" 
                        ControlToValidate="tbx_Email" Display="Dynamic" 
                        ErrorMessage="The email has been registed." 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="tbx_EmailConfirm" Display="Dynamic" 
                        ErrorMessage="Please enter your confirm email." 
                        ValidationGroup="Nexus_Control_Login">*</asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="CompareValidator1" runat="server" 
                        ControlToCompare="tbx_Email" ControlToValidate="tbx_EmailConfirm" 
                        Display="Dynamic" ErrorMessage="Your confirm email is different." 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ControlToValidate="tbx_Password" Display="Dynamic" 
                        ErrorMessage="Password must be between 8 and 12 characters, contain at least one digit and one alphabetic character, and must not contain special characters." 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                        ControlToValidate="tbx_PasswordConfirm" Display="Dynamic" 
                        ErrorMessage="Please enter your confirm password." 
                        ValidationGroup="Nexus_Control_Login">*</asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="CompareValidator2" runat="server" 
                        ControlToCompare="tbx_Password" ControlToValidate="tbx_PasswordConfirm" 
                        Display="Dynamic" ErrorMessage="Your confirm password is different." 
                        ValidationGroup="Nexus_Control_Login">*</asp:CompareValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:Button ID="btn_Submit" runat="server" Text="Sign up"
                        ValidationGroup="Nexus_Control_Login" OnClick="btn_Submit_Click" />
                </td>
            </tr>
        </table>
        <fieldset class="UserControlProperties">
            <legend>Successful Text </legend>
