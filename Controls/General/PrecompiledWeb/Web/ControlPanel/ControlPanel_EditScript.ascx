<%@ control language="C#" autoeventwireup="true" inherits="Nexus.Controls.General.ControlPanel.EditScript, App_Web_jvoxhdcg" classname="Nexus.Controls.General.ControlPanel.ControlPanel_EditScript" %>
            <div>
            Item Name *
