<%@ control language="C#" autoeventwireup="true" inherits="Nexus.Controls.General.RichText.Editor, App_Web_m2cguvzv" classname="Nexus.Controls.General.RichText.RichText_Editor" %>
