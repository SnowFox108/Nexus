<%@ control language="C#" autoeventwireup="true" inherits="Nexus.Controls.General.Management.ManageScript, App_Web_uf1w4axz" classname="Nexus.Controls.General.Management.Management_ManageScript" %>
<table>
    <tr>
