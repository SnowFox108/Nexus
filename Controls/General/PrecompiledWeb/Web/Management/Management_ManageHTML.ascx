<%@ control language="C#" autoeventwireup="true" inherits="Nexus.Controls.General.Management.ManageHTML, App_Web_uf1w4axz" classname="Nexus.Controls.General.Management.Management_ManageHTML" %>
<table>
    <tr>
