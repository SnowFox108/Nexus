<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Image_Editor.ascx.cs" Inherits="Nexus.Controls.General.Image.Editor" ClassName="Nexus.Controls.General.Image.Image_Editor" %>
