<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HTML_Editor.ascx.cs" Inherits="Nexus.Controls.General.HTML.Editor"
    ClassName="Nexus.Controls.General.HTML.HTML_Editor" %>
<asp:MultiView ID="MultiView_Editor" runat="server">
    ...
    <asp:View ID="View_SelectContent" runat="server">
        ...
        <div>
            ...
            <asp:GridView ID="GridView_HTML_Items" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                DataKeyNames="HTMLID" OnSelectedIndexChanged="GridView_HTML_Items_SelectedIndexChanged" Width="350px">
                <EmptyDataTemplate>
                    <p>
