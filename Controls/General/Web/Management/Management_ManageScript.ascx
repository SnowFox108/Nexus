<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Management_ManageScript.ascx.cs"
    Inherits="Nexus.Controls.General.Management.ManageScript" ClassName="Nexus.Controls.General.Management.Management_ManageScript" %>
<table>
    <tr>
                    ...
                    <tr style="background-color: #DCDCDC; color: #000000;">
                        <td>
                            <asp:CheckBox ID="chk_Selected" runat="server" /><asp:HiddenField ID="Hidden_ItemID"
                                runat="server" Value='<%# Eval("ScriptID") %>' />
                        </td>
                        <td>
                            <%# Eval("Display_Name") %>
                        </td>
                        <td>
                            <%# Nexus.Core.StringEnum.GetStringValue((Nexus.Controls.General.Lib.Script_Type)Eval("Script_Type"))%>
                        </td>
                        <td>
                            <%# Eval("Create_Date") %>
                        </td>
