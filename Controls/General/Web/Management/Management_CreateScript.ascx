<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Management_CreateScript.ascx.cs"
    Inherits="Nexus.Controls.General.Management.CreateScript" ClassName="Nexus.Controls.General.Management.Management_CreateScript" %>
