<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Management_CreateRichText.ascx.cs"
    Inherits="Nexus.Controls.General.Management.CreateRichText" ClassName="Nexus.Controls.General.Management.Management_CreateRichText" %>
