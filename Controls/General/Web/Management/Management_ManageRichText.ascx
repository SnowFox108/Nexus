<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Management_ManageRichText.ascx.cs"
    Inherits="Nexus.Controls.General.Management.ManageRichText" ClassName="Nexus.Controls.General.Management.Management_ManageRichText" %>
<table>
    <tr>
                    ...
                    <tr style="background-color: #DCDCDC; color: #000000;">
                        <td>
                            <asp:CheckBox ID="chk_Selected" runat="server" /><asp:HiddenField ID="Hidden_ItemID"
                                runat="server" Value='<%# Eval("RichTextID") %>' />
                        </td>
                        <td>
                            <%# Eval("Display_Name") %>
                        </td>
