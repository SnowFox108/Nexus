<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlPanel_EditRichText.ascx.cs"
    Inherits="Nexus.Controls.General.ControlPanel.EditRichText" ClassName="Nexus.Controls.General.ControlPanel.ControlPanel_EditRichText" %>
            <div>
            Item Name *
