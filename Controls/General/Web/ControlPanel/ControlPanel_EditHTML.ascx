<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ControlPanel_EditHTML.ascx.cs"
    Inherits="Nexus.Controls.General.ControlPanel.EditHTML" ClassName="Nexus.Controls.General.ControlPanel.ControlPanel_EditHTML" %>
        <div>
            Item Name *
