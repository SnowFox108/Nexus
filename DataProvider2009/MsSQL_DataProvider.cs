...
//
// Dataprovider for MsSQL
// version 1.011
// Last Update Date 05 December 2009
...
namespace e2Tech.MsSQL
{
    ...
    public class MsSQL_DataProvider
    {

        private SqlConnection MsSqlConn = new SqlConnection();
        ...
        public MsSQL_DataProvider(string DataPath)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        protected DataSet Show_Items(string Table_Name, string ReturnColum, string Filter, string OrderBy, int TopRows)
        {
            ...
            SqlDataAdapter sqlDbAdp = new SqlDataAdapter(sqlCMD, MsSqlConn);
        ...
        protected bool chk_Exist(string Table_Name, string Filter)
        {
            ...
            SqlCommand ExeCMD = new SqlCommand(sqlCMD, MsSqlConn);
        ...
        protected void Insert_Data_Field(string Table_Name, string[] Update_Field, string[] Update_Value, object[] DbType)
        {
            ...
            if (using_transaction)
            {
                ...
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    SqlCommandBuilder myCB = new SqlCommandBuilder(sqlDbAdp);
        ...
        protected void Delete_Table(string Table_Name)
        {
            ...
            SqlCommand DelCommand = new SqlCommand(DelCMD, MsSqlConn);
