...
public partial class User_Files_WebUserControls_TravelCentre_EnquiryForm : System.Web.UI.UserControl
{
    ...
    protected void CustomValidator_ReturnDate_ServerValidate(object source, ServerValidateEventArgs args)
    {
        ...
        try
        {
            ...
            {
                CustomValidator_ReturnDate.ErrorMessage = "Your Return Date is in past";
                args.IsValid = false;
            }
        ...
        try
        {
            ...
            {
                CustomValidator_ReturnDate.ErrorMessage = "Your Return date is earlier than or same as Depature date";
                args.IsValid = false;
            }
        }
        catch
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            Nexus.Core.Email.EmailMgr.SendMail(null,
                ...
                tbx_Email.Text,
                Email_Content,
                "An Enquiry from Travel Centre Clapham",
                false
                );
