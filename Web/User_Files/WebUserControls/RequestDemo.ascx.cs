...
public partial class User_Files_WebUserControls_RequestDemo : System.Web.UI.UserControl
{
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            string Email_Content = string.Format(Nexus.Core.Phrases.PhraseMgr.Get_Phrase_Value("e2Tech_RequestDemo_Email"),
                droplist_Location.SelectedValue,
                tbx_FirstName.Text,
                tbx_LastName.Text,
                tbx_Email.Text,
                tbx_Telephone.Text,
