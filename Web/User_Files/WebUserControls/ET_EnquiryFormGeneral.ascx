<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ET_EnquiryFormGeneral.ascx.cs" Inherits="User_Files_WebUserControls_ET_EnquiryFormGeneral" %>
                    ...
                    <asp:View ID="View_Form" runat="server">
                        ...
                        <table style="border-collapse: separate; border-spacing: 5px;">
                            <tbody>
                                ...
                                <tr>
                                    <th style="text-align: right;">團號:
                                    </th>
                                    <td>
                                        <asp:TextBox ID="tbx_Code" runat="server" MaxLength="150" Width="200px" ValidationGroup="EnquiryForm"></asp:TextBox>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <th style="text-align: right;">出發日期:
                                    </th>
                                    <td>
