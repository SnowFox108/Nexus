<%@ Page Language="C#" MasterPageFile="~/App_AdminCP/SiteAdmin/MasterPage_AdminCP.master"
    AutoEventWireup="true" CodeFile="PageProperties.aspx.cs" Inherits="Nexus.Core.App_AdminCP_SiteAdmin_PageProperties"
    Title="Website Control Panel - Page Properties" StylesheetTheme="NexusCore" %>
...
<%@ Register Src="Pages/PageProperties.ascx" TagName="PageProperties" TagPrefix="nexus" %>
            ...
            <asp:MultiView ID="MultiView_Pages" runat="server">
                <asp:View ID="View_ListPage" runat="server">
                    <div class="nexusCore_pages_pageList">
                        <nexus:PageList ID="PageList_Index" PageEdit_URL="PageProperties.aspx" runat="server" />
                    </div>
                </asp:View>
                <asp:View ID="View_ShowPage" runat="server">
                    ...
                    <div class="nexusCore_pages_pageShow">
                        <nexus:PageProperties ID="PageProperties_Property" runat="server" />
                    </div>
                </asp:View>
