// JavaScript Document
	...
	************************************************************************************************************/		
	var panelWidth = 235;	// Width of help panel	
	...
	function initSlideLeftPanel(expandOnly)
	{
		...
		if(!slideLeftPanelObj){
		    if (document.getElementById('ctl00_NexusCore_Editor_Toolbox')) {	// Object exists in HTML code?
		        slideLeftPanelObj = document.getElementById('ctl00_NexusCore_Editor_Toolbox');
				...
				slideLeftPanelObj.id = 'ctl00_NexusCore_Editor_Toolbox';
