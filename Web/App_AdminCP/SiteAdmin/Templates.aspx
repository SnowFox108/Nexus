<%@ Page Language="C#" MasterPageFile="~/App_AdminCP/SiteAdmin/MasterPage_AdminCP.master"
    AutoEventWireup="true" CodeFile="Templates.aspx.cs" Inherits="Nexus.Core.App_AdminCP_SiteAdmin_Templates"
    Title="Website Control Panel - Templates" StylesheetTheme="NexusCore" %>

<%@ Register Src="Templates/TemplateShow.ascx" TagName="TemplateShow" TagPrefix="nexus" %>
            ...
            <asp:MultiView ID="MultiView_Templates" runat="server">
                <asp:View ID="View_ListTemplate" runat="server">
                    <div class="nexusCore_templates_templatesList">
                        <nexus:TemplateList ID="TemplateList" runat="server" />
                    </div>
                </asp:View>
                <asp:View ID="View_ShowTemplate" runat="server">
                    <div class="nexusCore_templates_templatesShow">
                        <nexus:TemplateShow ID="TemplateShow_MasterPage" runat="server" />
                    </div>
                </asp:View>
