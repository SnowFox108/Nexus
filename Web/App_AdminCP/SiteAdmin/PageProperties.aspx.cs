...
namespace Nexus.Core
{
    ...
    public partial class App_AdminCP_SiteAdmin_PageProperties : System.Web.UI.Page
    {
        ...
        {
            PageMenu_PageIndex.Selected_PageIndexID = "-1";
        ...
        protected void PageCommand_Live_PageIndex_CreatePageClick(object sender, EventArgs e)
        {
            ...
            if (DataEval.IsEmptyQuery(PageCommand_Live_PageIndex.PageIndexID))
            {
                PageCreate_Create.Parent_PageIndexID = "-1";
            }
            else
            {
                PageCreate_Create.Parent_PageIndexID = PageCommand_Live_PageIndex.PageIndexID;
            }

        }

        protected void PageCommand_Live_PageIndex_DeletePageClick(object sender, EventArgs e)
        {
            // Remove delete page
