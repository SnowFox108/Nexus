...
namespace Nexus.Core
{
    ...
    public partial class App_AdminCP_SiteAdmin_TemplateProperties : System.Web.UI.Page
    {
        ...
        private void Page_Controls()
        {
            ...
            {
                TemplateProperties_Property.MasterPageIndexID = _masterpageindexid;
                MultiView_Templates.SetActiveView(View_ShowTemplate);
            }
            else
            {
        ...
        {
            TemplateProperties_Property.MasterPageIndexID = e.CommandArgument.ToString();
            MultiView_Templates.SetActiveView(View_ShowTemplate);
        }
