...
<div class="nexusCore_createTemplate" >
<table>
    <tr>
        <th>
            MasterPage Name
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="droplist_Template" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource_Template"
                        DataTextField="Template_Name" DataValueField="TemplateID" OnSelectedIndexChanged="droplist_Template_SelectedIndexChanged" >
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="droplist_Masterpage" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource_Masterpage"
                        DataTextField="MasterPage_Template_Name" DataValueField="Template_MasterPageID" OnSelectedIndexChanged="droplist_Masterpage_SelectedIndexChanged" >
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="droplist_Theme" runat="server" DataSourceID="ObjectDataSource_Theme"
                        ...
                        ondatabound="droplist_Theme_DataBound" >
                    </asp:DropDownList>
...
<div class="nexusCore_btn_goRight">
    <asp:Button ID="btn_AddMasterpage" runat="server" Text="Create a Masterpage" OnClick="btn_AddMasterpage_Click" SkinID="e2CMS_Button"  />
</div>
