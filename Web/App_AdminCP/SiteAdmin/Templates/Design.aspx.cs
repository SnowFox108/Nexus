...
public partial class App_AdminCP_SiteAdmin_Templates_Design : System.Web.UI.Page
{
    ...
    private void Page_Init()
    {
        ...
        Panel myToolboxPanel = new Panel();
        myToolboxPanel.CssClass = "nexusCore_Editor_ToolPanel";
        myToolboxPanel.ScrollBars = ScrollBars.Auto;
        ...
        RadTreeView_Toolbox.Skin = "WebBlue";
        //RadTreeView_Toolbox.ForeColor = System.Drawing.Color.Black;
        ...
        myToolboxPanel.Controls.Add(myToolbox_TopDiv);
        myToolboxPanel.Controls.Add(myToolbox_BotDiv);
        myPlaceHolder.Controls.Add(myToolboxPanel);
    ...
    protected override void OnPreInit(EventArgs e)
    {
        ...
        Template_MasterPage myTemplate_MasterPage = myTemplateMgr.Get_Template_MasterPage(myMasterPage_Lock.Template_MasterPageID);
