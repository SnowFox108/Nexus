<%@ Page Language="C#" MasterPageFile="~/App_AdminCP/ShopAdmin/MasterPage_AdminCP_Rad.master"
    AutoEventWireup="true" CodeFile="Categories.aspx.cs" Inherits="Nexus.Shop.App_AdminCP_ShopAdmin_Categories" 
    Title="Shop Control Panel - Product Categories" StylesheetTheme="NexusShop" %>

<%@ Register Src="../SiteAdmin/Modules/CategoryCommand.ascx" TagName="CategoryCommand" TagPrefix="nexus" %>
<%@ Register Src="../SiteAdmin/Modules/CategoryCreate.ascx" TagName="CategoryCreate" TagPrefix="nexus" %>
<%@ Register Src="../SiteAdmin/Modules/CategoryProperty.ascx" TagName="CategoryProperty" TagPrefix="nexus" %>
